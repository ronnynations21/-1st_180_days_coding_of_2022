...
Back end: MySQL
Tools used: VS Code, Mockups, SO Linux, and I Not used Lamp Local Server, Instead of this I used PHP 7+, MySQL 8+ and Composer from Terminal. Is very instersting to use this last combination. Another tools: Spotify (Listen Music while Working), GitHub, Trello and Dr. Google for to Investigate, search information....
